 ...
 */
package com.grami.undirected_subgraphs.dataStructures;
...
import com.grami.undirected_subgraphs.search.SearchLatticeNode;
import utilities.DfscodesCache;
import utilities.Settings;
import utilities.Util;

import com.grami.undirected_subgraphs.CSP.ConstraintGraph;
import com.grami.undirected_subgraphs.CSP.DFSSearch;
import com.grami.undirected_subgraphs.CSP.Variable;


/**
 * Implements the DFSCode that represents a subgraph during the
 * com.grami.undirected_subgraphs.search.
 * <p>
...
//			}
	 ...
	 * 
	 * com.grami.undirected_subgraphs.search for a smaller first edge or starts recursive extension for equally
	 * ones
	 * 
	 * @param set
	 * @param ackNodes
			...
			if (usedEdges[ack.gEdgei] != UNUSED) {
				...
				if (ack.getNodeB() == UNUSED) { // forward edge
					...
					final MinExtension<NodeType, EdgeType> exts = getExtensions(
							...
							usedNodes);
					set.addAll(exts);
					// recursiv com.grami.undirected_subgraphs.search
