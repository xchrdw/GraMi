...
import com.grami.undirected_subgraphs.dataStructures.Canonizable;
import com.grami.undirected_subgraphs.dataStructures.Extension;



/**
 * This class implements the general com.grami.undirected_subgraphs.pruning of non-canonical fragments.
 * 
...
public class CanonicalPruningStep<NodeType, EdgeType> extends
	...
	/**
	 * creates a new canonical com.grami.undirected_subgraphs.pruning object
	 * 
	 * @param next
	 */
