...
import com.grami.undirected_subgraphs.dataStructures.Frequency;
import com.grami.undirected_subgraphs.dataStructures.Frequented;


/**
 * This class implements the general com.grami.undirected_subgraphs.pruning of fragments according to their
 * frequency.
 * 
...
public class FrequencyPruningStep<NodeType, EdgeType> extends
	...
	/**
	 * creates a new frequency com.grami.undirected_subgraphs.pruning
	 * 
	 * @param next
	 * @param min
	 * @param max
