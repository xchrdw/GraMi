 ...
 */
package com.grami.directed_subgraphs.AlgorithmInterface;

import java.io.Serializable;
import java.util.Iterator;

import com.grami.directed_subgraphs.search.Extender;
import com.grami.directed_subgraphs.search.Generic;
...
public interface Algorithm<NodeType, EdgeType> extends
	 ...
	 * 
	 * @param graphs
	 *            the set of graphs that will be com.grami.directed_subgraphs.search for frequent fragments
	 * @param factory
	 *            the factory new graphs will be created with
	 * @param settings
	 *            the settings for the com.grami.directed_subgraphs.search
...
//			final Settings<NodeType, EdgeType> settings);
	...
	/**
	 * @return an iterator over the initial nodes for the com.grami.directed_subgraphs.search
	 */
