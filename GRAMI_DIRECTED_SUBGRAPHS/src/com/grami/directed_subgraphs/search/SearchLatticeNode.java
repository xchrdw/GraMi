...
import com.grami.directed_subgraphs.dataStructures.Generic;
import com.grami.directed_subgraphs.dataStructures.HPListGraph;
import com.grami.directed_subgraphs.dataStructures.serializableObject;

/**
 * This class defines the interface and basic functionality of a single node in
 * a com.grami.directed_subgraphs.search lattice.
 * 
...
public abstract class SearchLatticeNode<NodeType, EdgeType>  implements
	...
	/**
	 * @return the <code>level</code> (= depth in the com.grami.directed_subgraphs.search tree) of this
	 *         node
	 */
...
//			Collection<HPEmbedding<NodeType, EdgeType>> embs);
	...
	/**
	 * sets the <code>level</code> (= depth in the com.grami.directed_subgraphs.search tree) of this node
	 * 
	 * @param level
	 */
