...
import com.grami.directed_subgraphs.dataStructures.Frequency;
import com.grami.directed_subgraphs.dataStructures.Frequented;


/**
 * This class implements the general com.grami.directed_subgraphs.pruning of fragments according to their
 * frequency.
 * 
...
public class FrequencyPruningStep<NodeType, EdgeType> extends
	...
	/**
	 * creates a new frequency com.grami.directed_subgraphs.pruning
	 * 
	 * @param next
	 * @param min
	 * @param max
