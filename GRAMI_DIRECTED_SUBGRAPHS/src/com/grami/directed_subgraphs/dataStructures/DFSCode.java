 ...
 */
package com.grami.directed_subgraphs.dataStructures;
...
import com.grami.directed_subgraphs.search.SearchLatticeNode;
import com.grami.directed_subgraphs.utilities.DfscodesCache;
import com.grami.directed_subgraphs.utilities.Settings;
import com.grami.directed_subgraphs.utilities.Util;

import com.grami.directed_subgraphs.CSP.ConstraintGraph;
import com.grami.directed_subgraphs.CSP.DFSSearch;
import com.grami.directed_subgraphs.CSP.Variable;


/**
 * Implements the DFSCode that represents a subgraph during the
 * com.grami.directed_subgraphs.search.
 * <p>
...
//			}
	 ...
	 * 
	 * com.grami.directed_subgraphs.search for a smaller first edge or starts recursive extension for equally
	 * ones
	 * 
	 * @param set
	 * @param ackNodes
			...
			if (usedEdges[ack.gEdgei] != UNUSED) {
				...
				if (ack.getNodeB() == UNUSED) { // forward edge
					...
					final MinExtension<NodeType, EdgeType> exts = getExtensions(
							...
							usedNodes);
					set.addAll(exts);
					// recursiv com.grami.directed_subgraphs.search
