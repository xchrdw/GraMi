...
package com.grami.directed_subgraphs.CSP;
...
import com.grami.directed_subgraphs.automorphism.Automorphism;

import com.grami.directed_subgraphs.pruning.SPpruner;

import com.grami.directed_subgraphs.statistics.TimedOutSearchStats;
import com.grami.directed_subgraphs.utilities.MyPair;
import com.grami.directed_subgraphs.utilities.Settings;
import com.grami.directed_subgraphs.utilities.Util;

import com.grami.directed_subgraphs.dataStructures.HPListGraph;
import com.grami.directed_subgraphs.dataStructures.IntIterator;
import com.grami.directed_subgraphs.dataStructures.Query;
import com.grami.directed_subgraphs.dataStructures.StaticData;
import com.grami.directed_subgraphs.dataStructures.myNode;
import com.grami.directed_subgraphs.decomposer.Decomposer;
...
public class DFSSearch
{
	...
	//for automorphisms and non-cached com.grami.directed_subgraphs.search
	...
	public int hasBeenPrecomputed(Variable[] autos,int[] preComputed,int index) //if returns same index should com.grami.directed_subgraphs.search in it!!
	{
	...
	public void searchExistances()
	{
		...
		for (int i = variables.length-1; i >=0 ; i--) 
		{
			...
			for (Iterator<myNode> iterator = firstList.values().iterator(); iterator.hasNext();)
			{
				...
				//if already marked dont com.grami.directed_subgraphs.search it
			...
			//Timedout com.grami.directed_subgraphs.search
