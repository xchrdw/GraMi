...
package com.grami.directed_patterns.pruning;
...
import com.grami.directed_patterns.CSP.VariablePair;
import com.grami.directed_patterns.dataStructures.ConnectedComponent;
...
public class SPpruner 
{
	...
	public void getPrunedLists(ArrayList<HashMap<Integer,myNode>> candidatesByNodeID, Query qry)
	{
		...
		for (int i = 0; i < cls.size(); i++) 
		{
			...
			variables[nodeB].addConstrainedBy(nodeA);
		}
