...
import com.grami.directed_patterns.search.SearchLatticeNode;
import com.grami.directed_patterns.utilities.DfscodesCache;
import com.grami.directed_patterns.utilities.Settings;
import com.grami.directed_patterns.utilities.Util;

import com.grami.directed_patterns.CSP.ConstraintGraph;
import com.grami.directed_patterns.CSP.DFSSearch;
import com.grami.directed_patterns.CSP.Variable;


/**
 * Implements the DFSCode that represents a subgraph during the
 * com.grami.directed_patterns.search.
 * <p>
...
public class DFSCode<NodeType, EdgeType> extends
	...
	public final Frequency frequency() {
		...
		{
			//Constraints com.grami.directed_patterns.pruning
			//PRUNER
			//******* 1
...
//			}
	 ...
	 * 
	 * com.grami.directed_patterns.search for a smaller first edge or starts recursive extension for equally
	 * ones
	 * 
	 * @param set
	 * @param ackNodes
			...
			if (usedEdges[ack.gEdgei] != UNUSED) {
				...
				if (ack.getNodeB() == UNUSED) { // forward edge
					...
					final MinExtension<NodeType, EdgeType> exts = getExtensions(
							...
							usedNodes);
					set.addAll(exts);
					// recursiv com.grami.directed_patterns.search
