...
package com.grami.directed_patterns.CSP;
...
import com.grami.directed_patterns.automorphism.Automorphism;

import com.grami.directed_patterns.pruning.SPpruner;

import com.grami.directed_patterns.statistics.TimedOutSearchStats;
import com.grami.directed_patterns.utilities.Settings;
import com.grami.directed_patterns.utilities.Util;

import com.grami.directed_patterns.dataStructures.HPListGraph;
import com.grami.directed_patterns.dataStructures.IntIterator;
import com.grami.directed_patterns.dataStructures.Query;
import com.grami.directed_patterns.dataStructures.myNode;
import com.grami.directed_patterns.decomposer.Decomposer;
...
public class DFSSearch
{
	...
	//for automorphisms and non-cached com.grami.directed_patterns.search
	...
	public int hasBeenPrecomputed(Variable[] autos,int[] preComputed,int index) //if returns same index should com.grami.directed_patterns.search in it!!
	{
	...
	public void searchExistances()
	{
		...
		for (int i = variables.length-1; i >=0 ; i--) 
		{
			...
			for (Iterator<myNode> iterator = firstList.values().iterator(); iterator.hasNext();)
			{
				...
				//if already marked dont com.grami.directed_patterns.search it
			...
			//Timedout com.grami.directed_patterns.search
