...
import com.grami.directed_patterns.AlgorithmInterface.Algorithm;

import com.grami.directed_patterns.dataStructures.HPListGraph;


/**
 * This interface encapsulates the requirements of a com.grami.directed_patterns.search strategy.
 * 
...
public interface Strategy<NodeType, EdgeType> extends
	 ...
	 * 
	 * @param algo
	 *            the algorithm which com.grami.directed_patterns.search space will be used
