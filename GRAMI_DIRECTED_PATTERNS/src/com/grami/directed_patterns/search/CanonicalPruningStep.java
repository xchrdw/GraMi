...
import com.grami.directed_patterns.dataStructures.Canonizable;
import com.grami.directed_patterns.dataStructures.Extension;



/**
 * This class implements the general com.grami.directed_patterns.pruning of non-canonical fragments.
 * 
...
public class CanonicalPruningStep<NodeType, EdgeType> extends
	...
	/**
	 * creates a new canonical com.grami.directed_patterns.pruning object
	 * 
	 * @param next
	 */
