...
package com.grami.undirected_patterns.utilities;
...
public class CommandLineParser {
	...
	public static void parse(String[] args)
	{
		for(int i=0;i<args.length;i++)
		{
			...
			//assign the distance theshold for FPM
			if(key.compareTo("distance")==0)
				Settings.distance = Integer.parseInt(value);
			...
			//Automorphism
			if(key.compareTo("com/grami/undirected_patterns/automorphism")==0)
