...
package com.grami.undirected_patterns.pruning;
...
import com.grami.undirected_patterns.CSP.VariablePair;
import com.grami.undirected_patterns.dataStructures.ConnectedComponent;
...
public class SPpruner 
{
	...
	public void getPrunedLists(ArrayList<HashMap<Integer,myNode>> candidatesByNodeID, Query qry)
	{
		...
		for (int i = 0; i < cls.size(); i++) 
		{
			...
			variables[nodeA].addConstraintWith(nodeB);
			variables[nodeB].addConstraintWith(nodeA);
		}
