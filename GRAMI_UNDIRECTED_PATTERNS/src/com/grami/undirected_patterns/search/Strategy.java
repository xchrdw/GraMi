...
import com.grami.undirected_patterns.AlgorithmInterface.Algorithm;

import com.grami.undirected_patterns.dataStructures.HPListGraph;


/**
 * This interface encapsulates the requirements of a com.grami.undirected_patterns.search strategy.
 * 
...
public interface Strategy<NodeType, EdgeType> extends
	 ...
	 * 
	 * @param algo
	 *            the algorithm which com.grami.undirected_patterns.search space will be used
