...
/**
 * Cntains the whole chain of mining steps to generate the children of a com.grami.undirected_patterns.search node.
 * 
...
public class GSpanExtender<NodeType, EdgeType> extends
	...
	public Collection<SearchLatticeNode<NodeType, EdgeType>> getChildren(
		...
		// ArrayList for deteministic com.grami.undirected_patterns.search
