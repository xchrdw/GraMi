...
import com.grami.undirected_patterns.dataStructures.Frequency;
import com.grami.undirected_patterns.dataStructures.Frequented;


/**
 * This class implements the general com.grami.undirected_patterns.pruning of fragments according to their
 * frequency.
 * 
...
public class FrequencyPruningStep<NodeType, EdgeType> extends
	...
	/**
	 * creates a new frequency com.grami.undirected_patterns.pruning
	 * 
	 * @param next
	 * @param min
	 * @param max
