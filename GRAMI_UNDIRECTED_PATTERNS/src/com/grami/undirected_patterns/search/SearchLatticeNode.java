...
import com.grami.undirected_patterns.dataStructures.Generic;
import com.grami.undirected_patterns.dataStructures.HPListGraph;
import com.grami.undirected_patterns.dataStructures.serializableObject;

/**
 * This class defines the interface and basic functionality of a single node in
 * a com.grami.undirected_patterns.search lattice.
 * 
...
public abstract class SearchLatticeNode<NodeType, EdgeType>  implements
	...
	/**
	 * @return the <code>level</code> (= depth in the com.grami.undirected_patterns.search tree) of this
	 *         node
	 */
	...
	/**
	 * sets the <code>level</code> (= depth in the com.grami.undirected_patterns.search tree) of this node
	 * 
	 * @param level
	 */
